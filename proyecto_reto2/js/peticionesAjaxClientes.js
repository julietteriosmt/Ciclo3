...
function consultar_todo(){
    $.ajax({
        url:"https://ga2f6ecc5ac84b5-ektmqsoj5ox2g4qi.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/client/client",
        type:"GET",
        datatype:"json",
...
function consultaID(id){
	...
	if(!validarCampo($("#id"))){
		...
		$.ajax({
			url: 'https://ga2f6ecc5ac84b5-ektmqsoj5ox2g4qi.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/client/client'+ id.val(),			
			type: 'GET',
			dataType: 'json',
